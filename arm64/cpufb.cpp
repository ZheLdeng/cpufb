...
static void cpufb_register_isa()
{
    ...
    // looking at.
    reg_new_isa("asimd", "fmla.mul.vs(f32,f32,f32)_latency", "FLOPS",
        kLatencyLoopTime, 192LL, (void *)asimd_fmla_mul_vs_f32f32f32_latency);
    reg_new_isa("asimd", "fmla.mul.vs(f32,f32,f32)", "FLOPS", kComputeLoopTime,
        192LL, (void *)asimd_fmla_vs_f32f32f32);
    reg_new_isa("asimd", "fmla.mul.vs(f64,f64,f64)_latency", "FLOPS",
        kLatencyLoopTime, 96LL, (void *)asimd_fmla_mul_vs_f64f64f64_latency);
    reg_new_isa("asimd", "fmla.mul.vs(f64,f64,f64)", "FLOPS", kComputeLoopTime,
        96LL, (void *)asimd_fmla_vs_f64f64f64);
