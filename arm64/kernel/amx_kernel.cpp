...
void fmla16_benchmark_mat(long long looptime)
{
    ...
    // std::cout << time_used << std::endl;
    double perf =
        (double)looptime * (double)(32 * 32 * 2) * 8 / 1e9 / (time_used);
...
void fmla64_benchmark_mat(long long looptime)
{
    ...
    // std::cout << time_used << std::endl;
    double perf =
        (double)looptime * (double)(8 * 8 * 2) * 8 / 1e9 / (time_used);
...
void matint_i8i8_benchmark(long long looptime)
{
    ...
    // std::cout << time_used << std::endl;
    double perf =
        (double)looptime * (double)(64 * 64) * 2 * 8 / 1e9 / (time_used);
...
void matint_i8i16_benchmark(long long looptime)
{
    ...
    // std::cout << time_used << std::endl;
    double perf =
        (double)looptime * (double)(64 * 32) * 2 * 8 / 1e9 / (time_used);
