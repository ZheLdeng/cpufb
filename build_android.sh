...
do
    ...
    # $CC -mtune=generic -g -c $ASM/$SIMD.S -o $BUILD_DIR/$SIMD.o
...
$CXX -g -O2 -z noexecstack -pthread -static -o cpufp $BUILD_DIR/cpufp.o $BUILD_DIR/frequency.o $BUILD_DIR/thread_pool.o $BUILD_DIR/table.o $SIMD_OBJ 
set +x
