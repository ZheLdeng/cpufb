...
function(cpufb_detect_simd arch out_features)
    ...
    if(arch STREQUAL "arm64" AND NOT CMAKE_SYSTEM_NAME STREQUAL "Darwin")
        if(DEFINED CPUFB_SIMD_FEATURES_OVERRIDE AND NOT CPUFB_SIMD_FEATURES_OVERRIDE STREQUAL "")
            ...
            check_c_compiler_flag("-march=armv9.2-a+sme2+sme-b16b16" CPUFB_CC_HAS_SME_B16B16)
            check_c_compiler_flag("-march=armv9.2-a+sme2+sme-i16i64" CPUFB_CC_HAS_SME_I16I32)
            if(CPUFB_CC_HAS_SME)
            ...
            if(CPUFB_CC_HAS_SME_B16B16)
                list(APPEND features _SME_B16B16_)
            endif()
        ...
        if(_SMEf64_ IN_LIST features OR _SME_F16F16_ IN_LIST features OR
           _SME_B16B16_ IN_LIST features OR
