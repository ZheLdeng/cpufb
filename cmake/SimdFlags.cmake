...
function(cpufb_simd_asm_flags arch feature out_var)
    ...
    if(arch STREQUAL "arm64")
        ...
        elseif(feature STREQUAL "_SME_B16B16_")
            set(flag "-march=armv9.2-a+sme2+sme-b16b16")
        elseif(feature STREQUAL "_SME_I16I32_")
            set(flag "-march=armv9.2-a+sme2+sme-i16i64")
        ...
        elseif(feature STREQUAL "_SVE2_")
            # SVE2 is an Armv8 extension. Use armv8-a+sve2 rather than
            # armv9-a+sve2: GNU as 2.37 knows +sve2 but not the armv9-a
            # architecture name (that arrived in 2.38).
            set(flag "-march=armv8-a+sve2")
